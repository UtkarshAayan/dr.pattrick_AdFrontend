...
const routes: Routes = [
  { path:'auth', loadChildren: () => import('./views/pages/auth/auth.module').then(m => m.AuthModule) },
  {
    ...
    children: [
      ...
      {
        path: 'manageBasicProfile',
        loadChildren: () => import('./views/pages/manage-basic-profile/manage-basic-profile.module').then(m => m.ManageBasicProfileModule)
      },
      {
        path: 'apps',
      ...
      { path: '', redirectTo: 'manageBasicProfile', pathMatch: 'full' }, 
